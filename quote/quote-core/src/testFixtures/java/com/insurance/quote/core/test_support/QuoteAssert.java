...
public class QuoteAssert extends AbstractAssert<QuoteAssert, Quote> {
  ...
  public QuoteAssert hasStatus(QuoteStatus expected) {
    ...
    if (!Objects.equals(actual.getStatus(), expected)) {
      failWithMessage(
          "Expected quote status to be <%s> but was <%s>", expected, actual.getStatus());
    }
    return this;
  }
  ...
  public QuoteAssert hasPartnerNo(String expected) {
    ...
    if (!Objects.equals(actual.getPartnerNo(), expected)) {
      failWithMessage(
          "Expected quote partnerNo to be <%s> but was <%s>", expected, actual.getPartnerNo());
    }
    return this;
  }
  ...
  public QuoteAssert hasQuoteNo(String expected) {
    ...
    if (!Objects.equals(actual.getQuoteNo(), expected)) {
      failWithMessage(
          "Expected quote quoteNo to be <%s> but was <%s>", expected, actual.getQuoteNo());
    }
    return this;
  }
  ...
  public QuoteAssert hasCalculatedPremium(BigDecimal expected) {
    isNotNull();
    if (actual.getCalculatedPremium() == null
        || actual.getCalculatedPremium().compareTo(expected) != 0) {
      failWithMessage(
          "Expected quote calculatedPremium to be <%s> but was <%s>",
          expected, actual.getCalculatedPremium());
    }
    return this;
  }
  ...
  public QuoteAssert hasInsuranceProduct(InsuranceProduct expected) {
    ...
    if (!Objects.equals(actual.getInsuranceProduct(), expected)) {
      failWithMessage(
          "Expected quote insuranceProduct to be <%s> but was <%s>",
          expected, actual.getInsuranceProduct());
    }
    return this;
  }
  ...
  public QuoteAssert hasPaymentFrequency(PaymentFrequency expected) {
    ...
    if (!Objects.equals(actual.getPaymentFrequency(), expected)) {
      failWithMessage(
          "Expected quote paymentFrequency to be <%s> but was <%s>",
          expected, actual.getPaymentFrequency());
    }
    return this;
  }
  ...
  public QuoteAssert hasEffectiveDate(LocalDate expected) {
    ...
    if (!Objects.equals(actual.getEffectiveDate(), expected)) {
      failWithMessage(
          "Expected quote effectiveDate to be <%s> but was <%s>",
          expected, actual.getEffectiveDate());
    }
    return this;
  }
  ...
  public QuoteAssert hasCreatedPolicyId(java.util.UUID expected) {
    ...
    if (!Objects.equals(actual.getCreatedPolicyId(), expected)) {
      failWithMessage(
          "Expected quote createdPolicyId to be <%s> but was <%s>",
          expected, actual.getCreatedPolicyId());
    }
    return this;
  }
  ...
  public QuoteAssert hasCreatedPolicyNo(String expected) {
    ...
    if (!Objects.equals(actual.getCreatedPolicyNo(), expected)) {
      failWithMessage(
          "Expected quote createdPolicyNo to be <%s> but was <%s>",
          expected, actual.getCreatedPolicyNo());
    }
    return this;
  }
  ...
  public QuoteAssert hasPolicyReference() {
    ...
    if (actual.getCreatedPolicyNo() == null || actual.getCreatedPolicyId() == null) {
      failWithMessage(
          "Expected quote to have policy reference but createdPolicyNo=<%s> createdPolicyId=<%s>",
