 ...
 *
 * <p>The quote module owns quote status transitions. Accepting a quote delegates policy creation to
 * the policy API and stores the created policy reference on the quote.
 */
public interface QuoteService {
  ...
  /**
   * Accepts a quote, creates the corresponding policy, and stores the policy reference on the
   * quote.
   *
