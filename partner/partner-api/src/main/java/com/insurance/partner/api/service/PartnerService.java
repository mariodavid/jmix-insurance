...
/**
 * Public partner API used by other modules to search, read, and persist customer records.
 *
 * <p>The partner module owns partner numbers and customer master data. Other modules should depend
 * on this contract instead of partner-core classes.
 */
public interface PartnerService {
   ...
   *
   * <p>If the DTO has an id, the existing partner is updated. Otherwise, a new partner is created
   * and a partner number is generated when none is supplied.
   *
