 ...
 * <p>
 * The account module owns account balances and accounting documents. Other
 * modules should depend on this contract instead of account-core classes.
 */
public interface AccountService {

    /**
     * Calculates the account balance for the account associated with the given
     * policy number at a specific effective date.
     * <p>
     * Only accounting documents with a document date on or before the effective
     * date are included in the returned balance.
     *
