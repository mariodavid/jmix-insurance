...
public class ProductApiConfiguration {
    ...
    @Bean("product_api_ProductViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.insurance.product.api"));
        return viewControllers;
    }

    @Bean("product_api_ProductActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.insurance.product.api"));
        return actions;
    }
}
