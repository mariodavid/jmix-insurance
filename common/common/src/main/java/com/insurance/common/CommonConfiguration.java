...
public class CommonConfiguration {
    ...
    @Bean("common_CommonViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.insurance.common"));
        return viewControllers;
    }

    @Bean("common_CommonActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.insurance.common"));
        return actions;
    }
}
