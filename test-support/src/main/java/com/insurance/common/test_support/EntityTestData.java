...
public class EntityTestData {
  ...
  /**
   * creates a new entity instance with the provided entity provisioning. The consumer allows to
   * further adjust the instance on a case-by-case basis.
   *
   * @param testDataProvider the entity provisioning to use
   ...
   * @return the created entity
   */
  public <Entity> Entity createWithDefaults(
      TestDataProvider<Entity> testDataProvider, Consumer<Entity> entityConsumer) {
   ...
   */
  public <Entity> Entity createWithDefaults(
      Class<Entity> entityType, Consumer<Entity> entityConsumer) {
  ...
  /**
   * creates and saves an entity instance with the provided entity provisioning. The consumer allows
   * to further adjust the instance on a case-by-case basis
   *
   * @param testDataProvider the entity provisioning to use
   * @param entityConsumer the entity provisioning consumer
   * @param <Entity> the type of the entity
   * @return the saved entity
   */
  public <Entity> Entity saveWithDefaults(
      TestDataProvider<Entity> testDataProvider, Consumer<Entity> entityConsumer) {
