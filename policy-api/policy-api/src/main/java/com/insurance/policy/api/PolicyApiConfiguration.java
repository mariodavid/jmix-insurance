...
public class PolicyApiConfiguration {
    ...
    @Bean("policy_api_PolicyViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.insurance.policy.api"));
        return viewControllers;
    }

    @Bean("policy_api_PolicyActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.insurance.policy.api"));
        return actions;
    }
}
