...
@JmixModule(dependsOn = {EclipselinkConfiguration.class, PolicyApiConfiguration.class, CommonConfiguration.class, AccountApiConfiguration.class, ProductApiConfiguration.class, io.jmix.security.SecurityConfiguration.class})
