...
public interface AccountCoreReadRole {
    ...
    @EntityAttributePolicy(entityClass = AccountDocument.class, attributes = "*", action = EntityAttributePolicyAction.VIEW)
    @EntityPolicy(entityClass = AccountDocument.class, actions = {EntityPolicyAction.READ})
