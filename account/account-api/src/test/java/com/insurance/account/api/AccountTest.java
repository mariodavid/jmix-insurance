...
@AnalyzeClasses(packages = "com.insurance.account.api", importOptions = ImportOption.DoNotIncludeTests.class)
@SpringBootTest
class AccountTest {

    @ArchTest
    static final ArchRule accountApiDoesNotDependOnCoreUiOrFlowUi = noClasses()
            .that().resideInAPackage("com.insurance.account.api..")
            .should().dependOnClassesThat().resideInAnyPackage(
                    "com.insurance.account.core..",
                    "com.insurance..ui..",
                    "io.jmix.flowui..");
    ...
    void given_accountDto_when_createdThroughDataManager_then_metadataAndInstanceNameAreStable() {
        ...
        assertThat(dto)
                .hasPolicyNo("HC-2025-000001")
                .hasBalance(new BigDecimal("120.00"));
