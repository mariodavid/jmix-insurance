...
class PolicyServiceTest {
  ...
  @Autowired
  private PolicyTestConfiguration.FailingPolicyCreatedEventOrchestrator
      failingPolicyCreatedEventOrchestrator;
  ...
  void given_validPolicyRequest_when_policyCreated_then_policyNoAndCoverageAreCorrect() {
    ...
    assertThat(policy.getCoverageStart()).as("coverageStart").isEqualTo(EFFECTIVE_DATE);
    ...
    assertThat(policy.getPremium()).as("premium").isEqualByComparingTo(new BigDecimal("240.00"));
  }
  ...
  @Test
  void
      given_unknownPaymentFrequencyId_when_policyCreated_then_illegalArgumentExceptionThrownAndNoPolicySaved() {
    // given
    CreatePolicyRequestDto request =
        new CreatePolicyRequestDto(
            "QT-00003",
  ...
  @Test
  void
      given_accountOrchestratorFails_when_policyCreated_then_exceptionPropagatesAndPolicyRollsBack() {
    // given
    CreatePolicyRequestDto request =
        new CreatePolicyRequestDto(
            "QT-00004",
