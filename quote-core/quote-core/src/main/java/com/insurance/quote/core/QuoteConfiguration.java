...
@JmixModule(dependsOn = {EclipselinkConfiguration.class, PolicyApiConfiguration.class, CommonConfiguration.class, PartnerApiConfiguration.class, QuoteApiConfiguration.class, ProductApiConfiguration.class})
