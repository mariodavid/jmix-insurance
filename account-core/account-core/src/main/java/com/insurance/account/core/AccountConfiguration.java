...
@JmixModule(dependsOn = {EclipselinkConfiguration.class, FlowuiConfiguration.class, PolicyApiConfiguration.class, CommonConfiguration.class, AccountApiConfiguration.class, ProductApiConfiguration.class})
...
public class AccountConfiguration {
    ...
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("com.insurance.account.core"));
    ...
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("com.insurance.account.core"));
        return actions;
    }
}
