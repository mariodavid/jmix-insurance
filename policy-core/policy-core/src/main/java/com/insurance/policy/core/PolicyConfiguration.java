...
@JmixModule(dependsOn = {EclipselinkConfiguration.class, AccountApiConfiguration.class, CommonConfiguration.class, PartnerApiConfiguration.class, PolicyApiConfiguration.class, ProductApiConfiguration.class})
