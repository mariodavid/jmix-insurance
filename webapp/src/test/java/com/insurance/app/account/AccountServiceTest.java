...
class AccountServiceTest extends BaseIntegrationTest {
  ...
  // Gültige UUIDs — PolicyService.findPolicyById() gibt null zurück → coverageEnd-Check wird
  // übersprungen
  ...
  void given_quarterlyAccount_when_balanceQueriedBeforeThirdPayment_then_partialSumReturned() {
    ...
    BigDecimal expectedPerPayment =
        PREMIUM.divide(new BigDecimal("4"), java.math.RoundingMode.HALF_UP);
    assertThat(balance)
