...
The application requires Java 21 and uses the embedded HSQL database.
...
To start the application, use the **Insurance App Jmix Application** run configuration in your IDE, or run the following command in the project root directory:
