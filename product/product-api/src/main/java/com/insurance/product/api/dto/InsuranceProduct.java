...
public enum InsuranceProduct implements EnumClass<String> {
    ...
    HOME_CONTENT_STANDARD_2024_01("HOME_CONTENT_STANDARD_2024_01", ProductType.HOME_CONTENT, ProductVariant.MEDIUM, LocalDate.of(2023, 6, 1), null),
    HOME_CONTENT_BASIC_2024_01("HOME_CONTENT_BASIC_2024_01", ProductType.HOME_CONTENT, ProductVariant.SMALL, LocalDate.of(2022, 1, 1), null);
